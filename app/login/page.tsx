          ...
          {step === 'operator' ? (
            <form onSubmit={handleRequestOtp} className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="name" className="text-sm font-medium leading-none">Your Name (optional)</label>
                <Input
                  id="name"
                  type="text"
                  value={name}
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              ...
              <div className="space-y-2">
                <label htmlFor="otp" className="text-sm font-medium leading-none">Enter OTP</label>
                <Input
                  id="otp"
                  type="text"
                  value={otp}
