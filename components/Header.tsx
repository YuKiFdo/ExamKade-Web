    ...
    <>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 lg:px-6">
          ...
          <nav className="hidden items-center gap-1 lg:flex">
            ...
            >
              ...
              {megaOpen && (
                <div className="absolute left-1/2 top-full z-50 mt-1 w-[540px] -translate-x-1/2 animate-slide-down">
      ...
      {mobileOpen && (
        <>
          ...
          />
          <nav className="fixed right-0 top-0 z-50 flex h-full w-80 max-w-[85vw] flex-col bg-popover border-l border-border animate-fade-in overflow-y-auto">
